                ...
                <div class="flex items-center gap-3 border-l border-gray-200 pl-4">
                    ...
                    <div class="relative group z-50">
                        ...
                        <div class="absolute right-0 top-full mt-1.5 w-60 bg-white border border-gray-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-1 overflow-hidden">
                            ...
                            <div class="py-1.5">
                                {{-- Profil Saya --}}
                                <a href="{{ route('profile.show') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-semibold text-gray-700 hover:bg-blue-50 hover:text-[#1a6bbf] transition-colors">
                            ...
                            <div class="border-t border-gray-100 py-1 bg-gray-50/50">
                                <form action="{{ route('logout') }}" method="POST" class="w-full">
                                    @csrf
                                    <button type="submit" class="w-full flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 transition-colors">
...
{{-- Drawer Header --}}
    ...
    @auth
        <div class="px-5 py-4 bg-[#f0f7ff] border-b border-blue-100">
            ...
            <a href="{{ route('profile.show') }}" class="mt-2 inline-flex items-center gap-1.5 text-xs font-bold text-[#1a6bbf] hover:underline">
