...
<div class="min-h-screen flex items-center justify-center relative bg-gray-900 py-12">
    ...
    <img src="{{ asset('assets/images/2.webp') }}" class="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay fixed" alt="Sukabumi Background">
    ...
    <div class="relative z-10 w-full max-w-md px-4">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-gray-300">Bergabunglah dengan komunitas traveler Visit Sukabumi.</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8">
            ...
            {{-- ══ TOMBOL DAFTAR DENGAN GOOGLE (1-KLIK) ══ --}}
            <div>
            ...
            @if(app()->environment('local'))
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="name" class="block text-xs font-medium text-gray-200 uppercase tracking-wider mb-1">Nama Lengkap</label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-medium text-gray-200 uppercase tracking-wider mb-1">Konfirmasi Password</label>
            ...
            @else
                <div class="mt-6 pt-4 border-t border-white/10 text-center">
                    ...
                    <div class="inline-flex items-center gap-1.5 text-xs text-gray-400">
                        ...
                        <span>Pendaftaran instan otomatis dengan akun Google</span>
                    </div>
                </div>
            @endif
        </div>
